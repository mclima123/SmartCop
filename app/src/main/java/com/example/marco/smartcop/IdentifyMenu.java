...
public class IdentifyMenu extends SwipeDismissBaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_identify_menu);
    }
    ...
    public void clickVehicle(View view){
        Intent intent = new Intent(this, IdentifyVehicle.class);
        startActivity(intent);
    }
}
